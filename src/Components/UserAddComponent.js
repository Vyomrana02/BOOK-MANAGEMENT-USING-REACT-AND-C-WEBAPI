        ...
        <div>
            <div className="form-body">
                <div className="firstName">
                    ...
                    <input className="form__input" type="text" id="firstName" onChange={(e)=>setFirstName(e.target.value)} placeholder="First Name"/>
                </div>
            ...
            <div class="footer">
                <button type="submit" class="btn" onClick={(e) => handleSubmit(e)}>Register</button>
            </div>
        </div>
        );
